...
for mtcl = 1:100
    ...
    for iter = [1, 4]
        ...
        for nAgent = 1:3
            ...
            for gr = 1:1:3
                ...
                toc
                while check && norm(kron(ones(1,m), eye(d)) * Theta{nAgent, gr, iter} / m - invsigma, 'fro') ^ 2 / norm(invsigma, 'fro') ^ 2 - minNMSE >= 1e-6
                    if nAgent == 1
                        if gr == 1
                            tau = 1.25 * tau;
                        elseif gr == 2
                ...
                toc
                while check && norm(kron(ones(1,m), eye(d)) * Theta_L{nAgent, gr, iter} / m - invsigma, 'fro') ^ 2 / norm(invsigma, 'fro') ^ 2 - minNMSE >= 1e-6
                    if nAgent == 1
                        if gr == 1
                            tau = 1.25 * tau;
                        elseif gr == 2
                ...
                toc
                while check && norm(kron(ones(1,m), eye(d)) * Theta_M{nAgent, gr, iter} / m - invsigma, 'fro') ^ 2 / norm(invsigma, 'fro') ^ 2 - minNMSE >= 1e-6
                    if nAgent == 1
                        if gr == 1
                            tau = 1.25 * tau;
                        elseif gr == 2
    ...
    save(name + ".mat", 'Theta_opt', 'Theta', 'Theta_L', 'Theta_M', 'times', 'times_L', 'times_M')
end
